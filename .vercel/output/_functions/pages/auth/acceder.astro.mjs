...
function AccederFormContent() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen flex relative overflow-hidden transition-colors duration-300", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "flex-1 flex flex-col justify-center px-6 py-12 lg:px-8 bg-[#FDFBFF]/80 backdrop-blur-sm relative z-10 transition-colors duration-300", children: /* @__PURE__ */ jsxs("div", { className: "w-full max-w-md mx-auto", children: [
      /* @__PURE__ */ jsxs(
        "a",
        {
          href: "/",
      ...
      /* @__PURE__ */ jsxs("div", { className: "mb-8", children: [
        /* @__PURE__ */ jsx("h1", { className: "text-2xl lg:text-3xl font-bold text-[#1E1B4B] mb-2", children: "Bienvenido de nuevo" }),
        /* @__PURE__ */ jsx("p", { className: "text-[#6B7280]", children: "Ingresa tus credenciales para acceder a tu espacio." })
      ] }),
      /* @__PURE__ */ jsxs("form", { onSubmit: handleSubmit, className: "space-y-5", children: [
        /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
          /* @__PURE__ */ jsx(Label, { htmlFor: "email", className: "text-[#1E1B4B]", children: "Correo electrónico" }),
          /* @__PURE__ */ jsxs("div", { className: "relative", children: [
            /* @__PURE__ */ jsx(Mail, { className: "absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-[#A89CFF]" }),
            /* @__PURE__ */ jsx(
              Input,
              {
                id: "email",
        ...
        /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "relative", children: [
            /* @__PURE__ */ jsx(Lock, { className: "absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-[#A89CFF]" }),
            /* @__PURE__ */ jsx(
              Input,
              {
                id: "password",
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
          ...
          /* @__PURE__ */ jsx(Label, { htmlFor: "remember", className: "text-sm text-[#6B7280] cursor-pointer font-normal", children: "Mantener sesión iniciada" })
        ] }),
        /* @__PURE__ */ jsx(
          Button,
          {
      ...
      /* @__PURE__ */ jsxs("div", { className: "relative my-8", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "relative flex justify-center text-xs uppercase", children: /* @__PURE__ */ jsx("span", { className: "bg-[#FDFBFF] px-3 text-[#6B7280]", children: "o continúa con" }) })
      ] }),
      ...
      /* @__PURE__ */ jsxs("p", { className: "mt-8 text-center text-sm text-[#6B7280]", children: [
        ...
        " ",
        /* @__PURE__ */ jsx("a", { href: "/auth/crear-cuenta", className: "text-[#A89CFF] hover:text-[#A89CFF]/80 font-medium transition-colors", children: "Crear cuenta" })
      ] })
    ] }) }),
    /* @__PURE__ */ jsxs("div", { className: "hidden lg:flex flex-1 relative overflow-hidden transition-colors duration-300", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "relative flex items-center justify-center w-full p-12", children: /* @__PURE__ */ jsxs("div", { className: "text-center max-w-md", children: [
        /* @__PURE__ */ jsx("div", { className: "relative w-64 h-[420px] mx-auto mb-8", children: /* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-white rounded-[2.5rem] shadow-2xl shadow-[#A89CFF]/20 border border-[#E8D4F8] overflow-hidden transition-colors", children: /* @__PURE__ */ jsx("div", { className: "absolute inset-2 bg-gradient-to-b from-[#E8D4F8]/30 to-[#FDFBFF] rounded-[2rem] overflow-hidden", children: /* @__PURE__ */ jsxs("div", { className: "p-5 pt-10", children: [
          /* @__PURE__ */ jsx("div", { className: "w-10 h-10 rounded-xl bg-[#A89CFF]/20 flex items-center justify-center mx-auto mb-3", children: /* @__PURE__ */ jsx(Heart, { className: "w-5 h-5 text-[#A89CFF]" }) }),
          /* @__PURE__ */ jsx("div", { className: "h-3 w-24 bg-[#A89CFF]/20 rounded-full mx-auto mb-2" }),
          /* @__PURE__ */ jsx("div", { className: "h-2 w-20 bg-[#E8D4F8] rounded-full mx-auto mb-6" }),
          /* @__PURE__ */ jsx("div", { className: "space-y-3", children: [1, 2, 3].map((i) => /* @__PURE__ */ jsx("div", { className: "bg-white/80 backdrop-blur rounded-xl p-3 border border-[#E8D4F8]/50", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsx("div", { className: "w-8 h-8 rounded-lg bg-gradient-to-br from-[#A89CFF]/20 to-[#E8D4F8]/30" }),
            /* @__PURE__ */ jsxs("div", { className: "flex-1 text-left", children: [
              /* @__PURE__ */ jsx("div", { className: "h-2 w-16 bg-[#E8D4F8] rounded-full mb-1" }),
              /* @__PURE__ */ jsx("div", { className: "h-1.5 w-24 bg-[#E8D4F8]/50 rounded-full" })
            ] })
          ] }) }, i)) })
        ] }) }) }) }),
        /* @__PURE__ */ jsx("h2", { className: "text-2xl font-bold text-[#1E1B4B] mb-3", children: "Tu espacio te espera" }),
        /* @__PURE__ */ jsx("p", { className: "text-[#6B7280]", children: "Accede para continuar construyendo recuerdos juntos." })
      ] }) })
    ] })
  ] });
}
function AccederForm() {
  return /* @__PURE__ */ jsx(ToastProvider, { children: /* @__PURE__ */ jsx(AccederFormContent, {}) });
}
...
const $$Acceder = createComponent(($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$Acceder;
  const structuredData = {
    "@context": "https://schema.org",
    "@type": "WebPage",
    name: "Acceder - Bimoora",
    description: "Inicia sesi\xF3n en Bimoora y accede a tu espacio privado con tu pareja."
  };
  return renderTemplate(_a || (_a = __template(['<html lang="es"> <head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><meta name="generator"', '><!-- Primary Meta Tags --><title>Acceder \u2014 Bimoora</title><meta name="title" content="Acceder \u2014 Bimoora"><meta name="description" content="Inicia sesi\xF3n en Bimoora y accede a tu espacio privado con tu pareja. Donde el amor deja memoria."><meta name="robots" content="noindex, nofollow"><meta name="theme-color" content="#A89CFF"><!-- Canonical URL --><link rel="canonical" href="https://bimoora.com/auth/acceder"><!-- Favicon --><link rel="icon" type="image/png"', '><link rel="apple-touch-icon"', '><!-- Preconnect for performance --><link rel="preconnect" href="https://fonts.googleapis.com"><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin><link href="https://fonts.googleapis.com/css2?family=Poppins:wght@300;400;500;600;700&display=swap" rel="stylesheet"><!-- Structured Data (JSON-LD) --><script type="application/ld+json">', "<\/script>", '</head> <body class="bg-gradient-to-br from-[#E8D4F8]/20 via-white to-[#FFC8DD]/10 transition-colors duration-300"> ', " </body></html>"])), addAttribute(Astro2.generator, "content"), addAttribute(LogoSinFondo.src, "href"), addAttribute(LogoSinFondo.src, "href"), unescapeHTML(JSON.stringify(structuredData)), renderHead(), renderComponent($$result, "AccederForm", AccederForm, { "client:load": true, "client:component-hydration": "load", "client:component-path": "/Users/omarbermejo/dev/bimoora-comming-soon/src/components/auth/AccederForm", "client:component-export": "default" }));
}, "/Users/omarbermejo/dev/bimoora-comming-soon/src/pages/auth/acceder.astro", void 0);

const $$file = "/Users/omarbermejo/dev/bimoora-comming-soon/src/pages/auth/acceder.astro";
const $$url = "/auth/acceder";
