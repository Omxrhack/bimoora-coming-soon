import { e as createComponent, g as addAttribute, o as renderScript, r as renderTemplate, h as createAstro, m as maybeRenderHead, p as defineScriptVars, k as renderComponent, q as renderTransition, l as renderHead, u as unescapeHTML } from '../chunks/astro/server_D13BJ9Xf.mjs';
import 'piccolore';
import 'clsx';
/* empty css                                 */
/* empty css                                            */
...
const $$ClientRouter = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<meta name="astro-view-transitions-enabled" content="true"><meta name="astro-view-transitions-fallback"${addAttribute(fallback, "content")}>${renderScript($$result, "/Users/omarbermejo/dev/bimoora-comming-soon/node_modules/astro/components/ClientRouter.astro?astro&type=script&index=0&lang.ts")}`;
}, "/Users/omarbermejo/dev/bimoora-comming-soon/node_modules/astro/components/ClientRouter.astro", void 0);
        ...
        /* @__PURE__ */ jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-4 py-4", children: [
              ...
              /* @__PURE__ */ jsx("div", { className: "pt-4 border-t border-[#E8D4F8]/50", children: /* @__PURE__ */ jsx(AuthNavbar, {}) })
            ] })
          }
        )
      ]
...
const $$Footer = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<footer class="bg-[#FDFBFF] border-t border-[#E8D4F8]/50 transition-colors duration-300"> <div class="container mx-auto px-4 lg:px-8 py-12 lg:py-16"> <div class="grid grid-cols-2 md:grid-cols-4 gap-8 lg:gap-12"> <!-- Brand --> <div class="col-span-2 md:col-span-1"> <a href="/" class="flex items-center gap-2 text-[#1E1B4B] font-semibold text-xl"> <span class="w-8 h-8 rounded-lg bg-gradient-to-br from-[#A89CFF] to-[#E8D4F8] flex items-center justify-center text-white text-sm font-bold shadow-md overflow-hidden"> <img class="w-full h-full object-cover"${addAttribute(LogoPng.src, "src")} alt="Bimoora Logo"> </span> <span class="bg-gradient-to-r from-[#1E1B4B] to-[#A89CFF] bg-clip-text text-transparent">
Bimoora
